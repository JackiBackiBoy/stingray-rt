...
// GFXDevice_Vulkan Implementation
struct GFXDevice_Vulkan::Impl {
	Impl(SR::Window& window);
	~Impl();
...
GFXDevice_Vulkan::Impl::Impl(SR::Window& window) : m_Window(window) {
	create_instance();
...
GFXDevice_Vulkan::GFXDevice_Vulkan(SR::Window& window) : GFXDevice(window) {
