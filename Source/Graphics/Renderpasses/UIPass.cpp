...
// UI Pass
UIPass::UIPass(GFXDevice& gfxDevice, SR::Window& window) :
...
void UIPass::begin_menu_bar(int width) {
	m_CursorOrigin = { 0.0f, 0.0f };
	draw_rect({ 0, 0 }, width, m_DefaultFont->boundingBoxHeight + UI_PADDING * 2, UI_WIDGET_PRIMARY_COL);
